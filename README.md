...
| **Enrichment** | hypergeometric over-representation on the DEG list — direction, set-size range, ranking and collections all adjustable, including a **Metabolic** collection — 1,533 human / 1,391 mouse sets assembled from the metabolic pathways of KEGG, Reactome, WikiPathways, Hallmark and PID and the metabolic terms of GO:BP and GO:MF, standing on its own ids; click a term for its member genes with their rank among every tested gene |
